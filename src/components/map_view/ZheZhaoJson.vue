...
async function loadJson() {
    ...
    await axios.get('https://geo.datav.aliyun.com/areas_v3/bound/geojson?code=100000').then(res => {
    ...
    let mask = new Cesium.Entity({
        polygon: {
            ...
            material: new Cesium.ColorMaterialProperty(Cesium.Color.GRAY.withAlpha(0.3))
        }
    });
